...
class CliConfigTest(unittest.TestCase):
    ...
    def test_show_and_clear_config_round_trip(self) -> None:
        ...
        self.assertNotIn("target=", shown.stdout)
        ...
        self.assertNotIn("target=", cleared.stdout)
    ...
    def test_removed_target_commands_are_rejected(self) -> None:
        result = self.run_cli("set-target", "127.0.0.1:1234")
        self.assertNotEqual(result.returncode, 0)
        self.assertIn("invalid choice: 'set-target'", result.stderr)
